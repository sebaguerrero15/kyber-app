    ...
    <article className="mt-4">
        <div className='container mx-auto'>
            ...
            <Link href="/caricatura" className='text-center'>
                <button className='w-52 h-32 text-center text-white bg-gradient-to-br from-sky-950 to-teal-900 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 border-transparent uppercase rounded-lg hover:border-4 hover:border-white hover:bg-black transition-all duration-100'>
                    SERIES ANIMACIÓN
                </button>
            </Link>
