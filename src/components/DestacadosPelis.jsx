          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-2 mb-5">
            {peliculas.map((pelicula) => (
               ...
               >
                 ...
                 <Image src={pelicula.image} width={250} height={200} alt={pelicula.name} className="w-[100px] sm:w-[200px] sm:h-[300px] rounded-xl transition-all duration-75 border-4 border-transparent hover:border-white"/>
