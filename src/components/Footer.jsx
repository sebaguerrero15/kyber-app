...
<footer className="bg-black rounded-lg shadow dark:bg-gray-900">
    <div className="w-full max-w-screen-xl mx-auto p-4 md:py-16 md:mt-12">
        <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <ul className="mb-6 space-y-2 text-md font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
                <li>
